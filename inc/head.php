...
session_start();
header("Content-Security-Policy: script-src 'self' *.google.com *.googleapis.com *.jquery.com *.bootstrapcdn.com t *.fontawesome.com; img-src *; default-src 'self' 'unsafe-inline' localhost; font-src *; connect-src *; style-src * 'unsafe-inline' ");
//get title for head
